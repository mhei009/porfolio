...
import mentattImage from '../Assets/images/mentatt.png';
import '../index.css';
...
const Projects = () => {
  ...
  const getImage = (title) => {
    switch (title) {
      ...
      case 'Mentatt - Mental Health Company Website':
      return mentattImage;
                ...
                <>
                  ...
                  <div className="project__buttons">
                    {project.codeLink ? (
                      ...
                      <span className="button disabled">Code Unavailable</span>
                    )}
                    {project.liveSiteLink ? (
                      ...
                      <span className="button disabled">Live Site Unavailable</span>
                    )}
                  </div>
                </>
              )}
